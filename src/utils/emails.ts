              ...
              <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="width:600px; max-width:600px; background:#ffffff;">
                ...
                <tr>
                  <td style="font-size:16px; line-height:26px; color:#000000; padding: 0 0 25px 0;">
                    <strong>${fullName}</strong> vient d'accepter votre invitation à déclaration <strong>${declarationName}</strong>, de l’administration <strong>${administrationName}</strong>.
                  </td>
                </tr>
                <tr>
                  <td style="font-size:16px; line-height:24px; color:#000000; padding: 0 0 25px 0;">
                    Vous pouvez à tout moment gérer son statut depuis l’onglet “Membres” de votre déclaration.
                  </td>
                </tr>
                <tr>
                 ...
                 <tr>
                  <td style="font-size:16px; line-height:24px; color:#000000; padding: 0 0 25px 0;">
                    <a href="${linkDeclarationList}" style="font-size:16px; color:#000091; display:inline-block;">
...
export function getInviteAcceptRecapEmailHtml({
	link,
	fullName,
	declarationName,
	administrationName,
