...
export const testEnvironmentOptions = [
	...
	{
		label: "Dragon Naturally Speaking (Windows ou Mac OSX)",
		value: "dragon_naturally_speaking_windows_mac",
	},
] as const;
...
export const kindOptions = [
	...
	{ label: "Ordre et sécurité publics", value: "Ordre et sécurité publics" },
	{
	...
	{ label: "Vie / séjour à l'étranger", value: "Vie / séjour à l'étranger" },
