...
The current Declaration details page (`/dashboard/declarations/[id]`) shows a Démarche tab with four tiles, each linking to its own child route:

- `/dashboard/declarations/[id]/infos`
- `/dashboard/declarations/[id]/audit`
- `/dashboard/declarations/[id]/contact`
- `/dashboard/declarations/[id]/schema`
...
- `/dashboard/declarations/[id]?section=infos` (default landing when `?section` is omitted)
- `/dashboard/declarations/[id]?section=audit-realisation` (audit Sub-sections use dotted-hyphenated slugs)
- `/dashboard/declarations/[id]?section=audit-outils`
- `/dashboard/declarations/[id]?section=audit-contenus`
- `/dashboard/declarations/[id]?section=audit-non-conformites`
- `/dashboard/declarations/[id]?section=schema`
- `/dashboard/declarations/[id]?section=contact`
...
- Existing bookmarks to `/dashboard/declarations/[id]/audit` etc. break unless redirects are added. (Redirects from `[id]/<section>.tsx` files to `[id]?section=<section>` are cheap and recommended.)
